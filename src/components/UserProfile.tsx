...
import { Edit3, Plus, Heart, X } from "lucide-react";
...
export function UserProfile({ userItems, favoriteItems, user, onItemClick, onSellNewItem, onEditItem, onEditProfile }: UserProfileProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 w-full">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="favorites" className="mt-6 w-full">
